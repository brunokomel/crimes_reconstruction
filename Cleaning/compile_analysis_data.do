...
use "$wd/census_cops_troop_lynch_vote_1870.dta", clear

append using "$wd/census_cops_troop_lynch_vote_1880.dta"

save "$wd/census_cops_troop_lynch_vote.dta", replace
